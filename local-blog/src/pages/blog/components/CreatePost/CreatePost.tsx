...
import { addPost, cancelEditingPost, updatePost } from 'pages/blog/blog.reduce';
...
export default function CreatePost() {
    const [formData, setFormData] = useState<Post>(initState);
    ...
    useEffect(() => {
        setFormData(editingPost || initState);
    }, [editingPost]);
    ...
    const handleCancleEditingPost = () => {
        disPatch(cancelEditingPost());
    };

    return (
        <form onSubmit={handleSubmit} onReset={handleCancleEditingPost}>
            <div className="mb-6">
            ...
            <div className="mb-6">
                <label
                    htmlFor="publishDate"
                    className={`mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300 ${
                        errorForm?.publishDate ? 'text-red-700' : ''
                    }`}
                >
                    Publish Date
                </label>
